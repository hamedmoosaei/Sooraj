...
class WarrantyInfoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        topViewinit(titleString: "مشاهده اطلاعات گارانتی")
        defaultInit()
    }
    override func viewDidAppear(_ animated: Bool) {
        super.viewDidAppear(animated)
        let contentWidth = scrollView.bounds.width
        let contentHeight = CGFloat(integerLiteral: 600)
    ...
    func topViewinit(titleString: String){
        ...
        topViewBtn.addTarget(self, action: #selector(WarrantyInfoViewController.backTapped(_:)), for: UIControlEvents.touchUpInside)
    }
    func defaultInit(){
...
//        view.bringSubview(toFront: btn)
    ...
    func showDetailsView(){
        ...
        NSLayoutConstraint(item: startWarrantyValue, attribute: .width, relatedBy: .equal, toItem: detailView, attribute: .width, multiplier: 0.35, constant: 0).isActive = true
...
//        startWarrantyValue.text = "۱۳۹۷/۱۰/۲۳ ۱۴:۳۰:۰۰"
        ...
        NSLayoutConstraint(item: stopWarrantyValue, attribute: .width, relatedBy: .equal, toItem: detailView, attribute: .width, multiplier: 0.35, constant: 0).isActive = true
...
//        stopWarrantyValue.text = "۱۳۹۷/۱۰/۲۳ ۱۴:۳۰:۰۰"
        ...
        let statusIcon = UIImageView(image: UIImage(named: "questionIcon"))
...
//        amperValue.text = "۶۰۰۰"
    ...
    func showError(str : String){
        ...
        NSLayoutConstraint(item: errorText, attribute: .width, relatedBy: .equal, toItem: errorView, attribute: .width, multiplier: 0.5, constant: 0).isActive = true
