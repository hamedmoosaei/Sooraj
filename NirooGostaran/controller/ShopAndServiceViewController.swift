//
//  ShopAndServiceViewController.swift
//  NirooGostaran
//
...
class ShopAndServiceViewController: UIViewController {
    let topView: UIImageView = UIImageView()
    
    override func viewDidLoad() {
        super.viewDidLoad()
        topViewinit(titleString: "فروشگاه و خدمات")
        defaultInit()
    }
    ...
    func topViewinit(titleString: String){
        ...
        topViewBtn.addTarget(self, action: #selector(ShopAndServiceViewController.backTapped(_:)), for: UIControlEvents.touchUpInside)
    }
